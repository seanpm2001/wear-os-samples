        ...
        CompactChip.Builder(context, "New", emptyClickable, deviceParameters)
            .setChipColors(
                ChipColors(
                    ...
                    /*contentColor=*/ context.getColor(R.color.secondary)
                )
            )
            .build()
    )
        ...
        if (contact.avatarUrl != null) {
            ...
            setButtonColors(
                ButtonColors(
                    ...
                    /*contentColor=*/ context.getColor(R.color.primary)
                )
            )
        }
    }
...
private fun MessageTilePreview() {
    ...
    LayoutRootPreview(
        ...
        addIdToImageMapping(
            MessagingTileRenderer.ID_IC_SEARCH, drawableResToImageResource(R.drawable.ic_search)
        )
    }
}
